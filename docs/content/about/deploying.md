...
[storage drivers](/distribution/storage-drivers). For more information, see
...
proxy in front of the registry. See the [recipes list](/distribution/recipes/).
...
systems. Refer to the following [background information](/distribution/spec/auth/token) and
...
- [Advanced "recipes"](/distribution/recipes)
- [Registry API](/distribution/spec/api)
- [Storage driver model](/distribution/storage-drivers)
- [Token authentication](/distribution/spec/auth/token)
